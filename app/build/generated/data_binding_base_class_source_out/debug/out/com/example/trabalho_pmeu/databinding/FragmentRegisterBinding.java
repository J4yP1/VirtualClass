...
public final class FragmentRegisterBinding implements ViewBinding {
  ...
  private FragmentRegisterBinding(@NonNull ScrollView rootView, @NonNull AppBarLayout appBarLayout,
      @NonNull Button btnLogin, @NonNull Toolbar toolbar) {
  ...
  public static FragmentRegisterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentRegisterBinding((ScrollView) rootView, appBarLayout, btnLogin, toolbar);
    }
